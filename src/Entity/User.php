...
class User implements  UserInterface
{
     ...
     * @Assert\Length(min="3", minMessage="Votre prénom doit avoir au moins 3 caractères !")
    ...
    private $firstName;
     ...
     /**
      * @ORM\Column(type="string", length=255)
      * @Assert\Length(min="3", minMessage="Votre nom doit avoir au moins 3 caractères !")
     ...
     * @Assert\Url(message="Taper une url valide pour votre avatar !")
     */
    private $picture;
    ...
    /**
     * @Assert\EqualTo(propertyPath="hash", message="Vos champs mot de passe ne correspondent pas !")
     */
     ...
     * @Assert\Length(min="100", minMessage="Votre description doit avoir au moins 100 caractères !")
     */
    private $description;
