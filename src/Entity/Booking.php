...
class Booking
{
    ...
    public function isBookableDates()
    {
       ...
       /* $formatDay = function($day) {
          return  new \DateTime(date('Y-m-d H:m:s', $day));

        };*/

        //Tableau des chaines de caractères de mes journées
        $days= array_map(function ($formatDate){
            return date('Y-m-d', $formatDate);
        }, $bookingDays);

        $notAvailable= array_map( function ($formatD){
            $formatD = date_timestamp_get($formatD);
            return date('Y-m-d',$formatD);
        }, $notAvailableDays);
     ...
     * @return  array Un tableau d'objets DateTime répresentant les jours de la reservation
     */
