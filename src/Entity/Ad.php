 ...
 * @UniqueEntity(
 *     fields={"title"},
 *     message="Une autre annonce possede déjà ce titre"
 * )
 */
class Ad
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min="10", minMessage="Le slug doit avoir plus de 10 caractères")
     */
    private $slug;
    ...
    /**
     * Permet  d'obtenir un tableau des jours qui ne sont pas disponibles pour cet apannonce
     * @return array
